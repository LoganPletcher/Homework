...
//int main()
//{
//	SaveGame SaveFileData = { 0, false, 0, "" };
...
//		case 4:
//			system("cls");												//Clears the text on the command console's screen.
//			cout << "Do you want to save or "							//Prints the orange text to the command console and tells the user to choose either 1 or 2.
//				<< "look at the saved data?\n"
//				<< "1 Save\n2 Display Save\n";
//			cin >> input;												//Prompts the user for input.
//			switch (input)												//A switch statement is created for the choices of the Saved Files option.
//			{
//			case 1:
//				system("cls");											//Clears the text on the command console's screen.
